            ...
            <form action="{{ route('book.update', [$book->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="columns">
                    <div class="field column is-6">
                        ...
                        <div class="control">
                            <input class="input" name="meta" type="text" value="{{ $book->meta }}">
                        </div>
                    </div>
                    ...
                    <div class="field column is-6">
                        ...
                        <div class="control">
                            <input class="input" name="meta_sk" type="text" value="{{ $book->meta_sk }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea name="description" class="textarea wysiwyg">{{ $book->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea name="description_sk" class="textarea wysiwyg">{{ $book->description_sk }}</textarea>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea name="poems" class="textarea wysiwyg">{{ $book->poems }}</textarea>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea name="poems_sk" class="textarea wysiwyg">{{ $book->poems_sk }}</textarea>
                    </div>
                </div>
                ...
                <div class="columns">
                    <div class="field column is-6">
                        ...
                        <div class="control">
                            <input class="input" name="buy" type="url" value="{{ $book->buy }}">
                        </div>
                    </div>
                    <div class="field column is-6">
                        <label class="label">Slide color <span class="preview"></span></label>
                        <div class="control">
                            <input class="input" name="slide_color" type="text" value="{{ $book->slide_color }}">
                        </div>
                    </div>
                </div>

                <div class="columns">
                    <div class="field has-text-centered column is-7">
                        <div class="hero is-white has-border">
                    ...
                    <div class="column is-5">
                        <h6 class="is-size-6">Current file:</h6>
                        <p>{{ $book->download }}</p>
                    </div>
                </div>
...
@section('styles')
    <style>
        .preview {
            ...
            height: 10px;
            width: 40px;
            background-color: {{ $book->slide_color }};
        }
    </style>
@endsection
