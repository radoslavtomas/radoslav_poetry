...
@section('content')
    ...
    <div class="columns">
        <div class="column is-4 is-offset-4 has-text-centered">
            <h1 class="is-size-2">Add new book</h1>
        </div>
    </div>
            ...
            <form action="{{ route('book.create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="field has-text-centered">
                    <div class="hero is-white has-border">
                        <label class="label m-t-15">Upload cover</label>
                ...
                <div class="field has-text-centered">
                    <div class="hero is-white has-border">
                        <label class="label m-t-15">Pdf to download</label>
                ...
                <div class="field has-text-centered">
                    <div class="hero is-white has-border">
                        <label class="label m-t-15">Background</label>
